...
@interface RNNobleToWarrior () <RCTCxxBridgeDelegate, RCTTurboModuleManagerDelegate> {
...
@implementation RNNobleToWarrior

static RNNobleToWarrior *instance = nil;
